...
import { IonItem, IonButton, IonLabel, IonList, IonItemSliding, IonItemOption, IonItemOptions, IonIcon, IonAlert, IonLoading, IonFab, IonFabButton, IonText, IonRefresher, IonRefresherContent, IonRow, IonCol, IonChip, IonGrid, IonTitle, IonThumbnail, IonCard, IonCardTitle, IonCardContent, } from '@ionic/react'
import "./Est.css"
import { trash, chevronBackOutline, chevronDownCircleOutline, heart, football, man, body, sad} from 'ionicons/icons'
