...
class Times extends React.Component {
    ...
    registerTime(){
        this.state.idPlayers.forEach(time => {
            time.forEach(jogador=>{
                /*Aqui tem que colocar a função pra chamar a api pra cadastrar os jogadores,
                a intenção é que ela é chamada após apertar o relógio pela primeira vez
                (para iniciar a partida). Dps q iniciar a partida, não se pode adicionar novos
                jogadores nem alterar seus nomes*/
            })
        });
    }    
    render() {
